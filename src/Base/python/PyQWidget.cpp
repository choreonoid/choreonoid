...
{
    nb::class_<QWidget, QObject> qWidget(m, "QWidget");

    nb::enum_<QWidget::RenderFlag>(qWidget, "RenderFlag", nb::is_arithmetic())
    ...
    nb::class_<QFlags<QWidget::RenderFlag>>(qWidget, "RenderFlags")
        .def(nb::init<>())
        .def("__init__", [](QFlags<QWidget::RenderFlag>* self, QWidget::RenderFlag f){
            new(self) QFlags<QWidget::RenderFlag>(f);
        })
        .def("__init__",
             [](QFlags<QWidget::RenderFlag>* self, const std::vector<QWidget::RenderFlag>& flags){
                 int vflags = 0;
                 for(auto& flag : flags){
                     vflags |= flag;
                 }
                 new(self) QFlags<QWidget::RenderFlag>(vflags);
             })
        ;

    // Only the enum -> QFlags direction is registered. The bidirectional
    // implicitly_convertible used in the pybind11 version causes an infinite
    // recursion (segfault) in nanobind.
    nb::implicitly_convertible<QWidget::RenderFlag, QFlags<QWidget::RenderFlag>>();
    ...
    qWidget
        ...
        .def("addAction", (void(QWidget::*)(QAction*)) &QWidget::addAction)
        .def("addActions",
        ...
        .def("backingStore", &QWidget::backingStore, nb::rv_policy::reference)
        .def("baseSize", &QWidget::baseSize)
        .def("childAt", (QWidget*(QWidget::*)(int,int)const) &QWidget::childAt, nb::rv_policy::reference)
        .def("childAt", (QWidget*(QWidget::*)(const QPoint&)const) &QWidget::childAt, nb::rv_policy::reference)
        ...
        .def("focusProxy", &QWidget::focusProxy, nb::rv_policy::reference)
        .def("focusWidget", &QWidget::focusWidget, nb::rv_policy::reference)
        ...
        .def("grab", &QWidget::grab, nb::arg("rectangle") = QRect(QPoint(0, 0), QSize(-1, -1)))
        .def("grabGesture", &QWidget::grabGesture, nb::arg("gesture"), nb::arg("flags") = Qt::GestureFlags())
        ...
        .def("grabShortcut", &QWidget::grabShortcut, nb::arg("key"), nb::arg("context") = Qt::WindowShortcut)
        .def("graphicsEffect", &QWidget::graphicsEffect, nb::rv_policy::reference)
        .def("graphicsProxyWidget", &QWidget::graphicsProxyWidget, nb::rv_policy::reference)
        ...
        .def("layout", &QWidget::layout, nb::rv_policy::reference)
        .def("layoutDirection", &QWidget::layoutDirection)
        .def("locale", &QWidget::locale)
        .def("mapFrom", (QPoint(QWidget::*)(const QWidget*,const QPoint&)const) &QWidget::mapFrom)
        .def("mapFromGlobal", (QPoint(QWidget::*)(const QPoint&)const) &QWidget::mapFromGlobal)
        .def("mapFromParent", (QPoint(QWidget::*)(const QPoint&)const) &QWidget::mapFromParent)
        .def("mapTo", (QPoint(QWidget::*)(const QWidget*,const QPoint&)const) &QWidget::mapTo)
        .def("mapToGlobal", (QPoint(QWidget::*)(const QPoint&)const) &QWidget::mapToGlobal)
        .def("mapToParent", (QPoint(QWidget::*)(const QPoint&)const) &QWidget::mapToParent)
        ...
        .def("nativeParentWidget", &QWidget::nativeParentWidget, nb::rv_policy::reference)
        .def("nextInFocusChain", &QWidget::nextInFocusChain, nb::rv_policy::reference)
        .def("normalGeometry", &QWidget::normalGeometry)
        .def("overrideWindowFlags", &QWidget::overrideWindowFlags)
        .def("palette", &QWidget::palette)
        .def("parentWidget", &QWidget::parentWidget, nb::rv_policy::reference)
        .def("pos", &QWidget::pos)
        .def("previousInFocusChain", &QWidget::previousInFocusChain, nb::rv_policy::reference)
        ...
        .def("render", (void(QWidget::*)(QPaintDevice*, const QPoint&, const QRegion&, QWidget::RenderFlags)) &QWidget::render,
             nb::arg("target"), nb::arg("targetOffset") = QPoint(), nb::arg("sourceRegion") = QRegion(),
             nb::arg("renderFlags") = QWidget::RenderFlags(QWidget::DrawWindowBackground | QWidget::DrawChildren))
        .def("render", (void(QWidget::*)(QPainter*painter, const QPoint&, const QRegion&, QWidget::RenderFlags)) &QWidget::render,
             nb::arg("painter"), nb::arg("targetOffset") = QPoint(), nb::arg("sourceRegion") = QRegion(),
             nb::arg("renderFlags") = QWidget::RenderFlags(QWidget::DrawWindowBackground | QWidget::DrawChildren))
        ...
        // QWidget takes ownership of its layout on the Qt side, so release the
        // Python-created layout from nanobind's ownership (see releaseOwnership).
        .def("setLayout",
             [](QWidget& self, python::OwnershipReleased<QLayout> l){
                 self.setLayout(l);
             }, nb::arg("layout"))
        ...
        .def("setShortcutAutoRepeat", &QWidget::setShortcutAutoRepeat, nb::arg("id"), nb::arg("enable") = true)
        .def("setShortcutEnabled", &QWidget::setShortcutEnabled, nb::arg("id"), nb::arg("enable") = true)
        ...
        .def("style", &QWidget::style, nb::rv_policy::reference)
        ...
        .def("window", &QWidget::window, nb::rv_policy::reference)
        .def("windowFilePath", &QWidget::windowFilePath)
        .def("windowFlags", &QWidget::windowFlags)
        .def("windowHandle", &QWidget::windowHandle, nb::rv_policy::reference)
