...
void exportPyItems(py::module m)
{
    ...
    itemClass
        ...
        .def("findItem", [](Item* self, const string& path){ return ItemPtr(self->findItem(path)); })
        .def("findChildItem", [](Item* self, const string& path){ return ItemPtr(self->findChildItem(path)); })
        .def("findSubItem", [](Item* self, const string& path){ return ItemPtr(self->findSubItem(path)); })
        .def("headItem", [](Item* self){ return ItemPtr(self->headItem()); })
        .def("getDescendantItems", [](Item* self) {
            ItemList<Item> items; items.extractChildItems(self); return items; })
    ...
    py::class_<PointSetItem, PointSetItemPtr, Item> (m, "PointSetItem")
        ...
        .def("attentionPoint", [](PointSetItem* self, int index){ return self->attentionPoint(index); })
    ...
    py::class_<MultiPointSetItem, MultiPointSetItemPtr, Item>(m, "MultiPointSetItem")
        ...
        .def("activePointSetItem", [](MultiPointSetItem* self, int index){ return PointSetItemPtr(self->activePointSetItem(index)); })
