...
#ifndef CNOID_PYTHON_SIM_SCRIPT_PLUGIN_PYTHON_SIM_SCRIPT_ITEM_H_INCLUDED
#define CNOID_PYTHON_SIM_SCRIPT_PLUGIN_PYTHON_SIM_SCRIPT_ITEM_H_INCLUDED
...
public:
    ...
    virtual SignalProxy< boost::signal<void()> > sigScriptFinished();
