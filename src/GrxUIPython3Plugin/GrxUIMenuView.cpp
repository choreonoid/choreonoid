...
public:
    ...
    MenuWidget(const py::list& menu, bool isLocalSequentialMode, bool doBackgroundExecution, GrxUIMenuViewImpl* view);
    void createPages(const py::list& menu);
    void addSection(const py::list& section);
...
public:
    ...
    void setMenu(const py::list& menu, bool isLocalSequentialMode, bool doBackgroundExecution);
...
void GrxUIMenuView::setCancelExceptionType(py::object exceptionType)
{
...
void GrxUIMenuView::setMenu(const py::list& menu, bool isLocalSequentialMode, bool doBackgroundExecution)
{
    impl->setMenu(menu, isLocalSequentialMode, doBackgroundExecution);
}


void GrxUIMenuViewImpl::setMenu(const py::list& menu, bool isLocalSequentialMode, bool doBackgroundExecution)
{
...
MenuWidget::MenuWidget
(const py::list& menu, bool isLocalSequentialMode, bool doBackgroundExecution, GrxUIMenuViewImpl* view)
    : view(view)
{
    QVBoxLayout* vbox = new QVBoxLayout();
...
void MenuWidget::createPages(const py::list& menu)
{
    int numSections = py::len(menu);
    for(int i=0; i < numSections; ++i){
        const py::list section = menu[i].cast<py::list>();
        addSection(section);
    }
...
void MenuWidget::addSection(const py::list& section)
{                        
