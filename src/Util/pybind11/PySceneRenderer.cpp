...
void exportPySceneRenderer(py::module& m)
{
    py::class_<SceneRenderer>(m, "SceneRenderer")
        ...
        .def_property("worldLight", &SceneRenderer::worldLight, &SceneRenderer::setWorldLight)
        .def("setWorldLight", &SceneRenderer::setWorldLight)
        .def_property_readonly("worldLightTransform", &SceneRenderer::worldLightTransform, py::return_value_policy::reference)
