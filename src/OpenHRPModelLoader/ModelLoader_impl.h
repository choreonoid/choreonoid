                          ...
                          public PortableServer::RefCountServantBase
{
  ...
  public:
    ...
    virtual OpenHRP::BodyInfo_ptr getBodyInfo(const char* url)
        throw (CORBA::SystemException, OpenHRP::ModelLoader::ModelLoaderException) override;

    virtual OpenHRP::BodyInfo_ptr getBodyInfoEx(const char* url, const OpenHRP::ModelLoader::ModelLoadOption& option )
        throw (CORBA::SystemException, OpenHRP::ModelLoader::ModelLoaderException) override;

    virtual OpenHRP::BodyInfo_ptr loadBodyInfo(const char* url)
        throw (CORBA::SystemException, OpenHRP::ModelLoader::ModelLoaderException) override;

    virtual OpenHRP::BodyInfo_ptr loadBodyInfoEx(const char* url, const OpenHRP::ModelLoader::ModelLoadOption& option)
        throw (CORBA::SystemException, OpenHRP::ModelLoader::ModelLoaderException) override;

    virtual OpenHRP::SceneInfo_ptr loadSceneInfo(const char* url)
        throw (CORBA::SystemException, OpenHRP::ModelLoader::ModelLoaderException) override;
