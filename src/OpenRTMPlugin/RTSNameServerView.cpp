...
namespace cnoid {
	...
	void RTSNameTreeWidget::deleteFromNameService() {
		...
		if (RTSNameServerView::instance()->getNCHelper().isAlive() == false) return;
...
void RTSNameServerViewImpl::updateObjectList(const NamingContextHelper::ObjectInfoList& objects, QTreeWidgetItem* parent, vector<NamingContextHelper::ObjectPath> pathList) {
