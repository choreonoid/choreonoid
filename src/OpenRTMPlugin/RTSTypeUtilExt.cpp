...
vector<string> RTSTypeUtilExt::getAllowDataTypes(RTSPortExt* source, RTSPortExt* target)
{
...
vector<string> RTSTypeUtilExt::getAllowInterfaceTypes(RTSPortExt* source, RTSPortExt* target)
{
...
vector<string> RTSTypeUtilExt::getAllowDataflowTypes(RTSPortExt* source, RTSPortExt* target)
{
    vector<string> result;
    if (source == 0 && target == 0) {
        return result;
...
vector<string> RTSTypeUtilExt::getAllowSubscriptionTypes(RTSPortExt* source, RTSPortExt* target)
{
    vector<string> result;
    if (source == 0 && target == 0) {
        return result;
...
//////////
vector<string> RTSTypeUtilExt::getAllowList(vector<string>& source, vector<string>& target, TypeComparer& comparer)
{
...
bool RTSTypeUtilExt::isAnyString(std::string target)
{
    return RTCCommonUtil::compareIgnoreCase(target, "Any");
}

bool RTSTypeUtilExt::isExistAny(vector<string> target)
{
    for (int index = 0; index < target.size(); index++) {
