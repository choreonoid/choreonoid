...
public:
    ...
    RTSPortExtPtr copyForChecking(); // Ext2
...
public:
    ...
    RTSConnectionExtPtr copyForChecking(); // Ext2
...
public:
    ...
    RTSCompExtPtr copyForChecking(); // Ext2
...
private:
    ...
    bool connectionCheckSubForChecking(RTSPortExt* rtsPort); // Ext2
