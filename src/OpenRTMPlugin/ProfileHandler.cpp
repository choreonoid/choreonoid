...
void ProfileHandler::buildPosition(const RTSConnection* connect, int offsetX, int offsetY, std::vector<Property>& propList)
{
    ...
    //////////
    //int posX1n = connect->position[1](0) + offsetX;
    //int posY1n = (connect->position[1](1) + connect->position[2](1)) / 2 + offsetY;

    //int posX2n = (connect->position[2](0) + connect->position[3](0)) / 2 + offsetX;
    //int posY2n = connect->position[2](1) + offsetY;

    //int posX3n = connect->position[3](0) + offsetX;
    //int posY3n = (connect->position[3](1) + connect->position[4](1)) / 2 + offsetY;

    //QString posX1 = QString::number(posX1n);
    //QString posY1 = QString::number(posY1n);
    //QString posX2 = QString::number(posX2n);
    //QString posY2 = QString::number(posY2n);
    //QString posX3 = QString::number(posX3n);
    //QString posY3 = QString::number(posY3n);
