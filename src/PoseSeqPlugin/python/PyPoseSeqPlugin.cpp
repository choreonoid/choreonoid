...
namespace cnoid
{
    ...
    BOOST_PYTHON_MODULE(PoseSeqPlugin)
    {
         ...
         */
        class_ < PoseSeqItem, ref_ptr<PoseSeqItem>, bases<Item>, boost::noncopyable >("PoseSeqItem", init<>())
            .def("__init__", boost::python::make_constructor(&createInstance<PoseSeqItem>));
    }
