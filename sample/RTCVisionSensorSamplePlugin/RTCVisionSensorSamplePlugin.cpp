...
class RTCVisionSensorSamplePlugin : public Plugin
{
...
public:
    ...
    RTCVisionSensorSamplePlugin() : Plugin("RTCVisionSensorSample")
        {
            require("Body");
            require("OpenRTM");
        }
    ...
    virtual bool initialize()
        {
            ...
            sigItemAddedConnection =
                RootItem::instance()->sigItemAdded().connect(
                    bind(&RTCVisionSensorSamplePlugin::onItemAdded, this, _1));
...
CNOID_IMPLEMENT_PLUGIN_ENTRY(RTCVisionSensorSamplePlugin);
